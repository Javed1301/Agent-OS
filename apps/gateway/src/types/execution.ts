...
/**
 * Full execution record stored in data/executions/<id>/output.json
 */
export interface ExecutionRecord {
  ...
  endTime?: string;
  durationMs?: number;
  /** Absolute path to the execution folder (data/executions/<id>/) */
  runDir: string;
...
/**
 * Lightweight index entry stored in data/executions/index.json
